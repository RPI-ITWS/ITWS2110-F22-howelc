...
document.getElementById("course-websys").addEventListener("click", function () {
    ...
    for (let i = 0; i < websysLectures.length; i++) {
        ...
        listHTML += lecNum + '</li >';
        lecList.insertAdjacentHTML("beforeend",listHTML);
        ...
        tabDisplay.insertAdjacentHTML("beforeend",tabHTML);
    }
    ...
    for (let i = 0; i < websysLabs.length; i++) {
        ...
        listHTML += labNum + '</li >';
        labList.insertAdjacentHTML("beforeend",listHTML);
